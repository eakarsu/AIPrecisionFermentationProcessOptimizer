...
export default function GapCostsWithoutCostPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-costs-without-cost/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Costs without '/cost</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Costs without /cost-optimization (media optimization, energy efficiency)</p>
