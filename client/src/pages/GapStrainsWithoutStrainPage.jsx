...
export default function GapStrainsWithoutStrainPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-strains-without-strain/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Strains without '/strain</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Strains without /strain-performance-predict (growth rate, yield, stress response)</p>
