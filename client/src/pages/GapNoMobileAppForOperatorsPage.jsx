...
// Gap (Non-AI): No mobile app for operators
// No mobile app for operators
import React, { useState } from 'react';

export default function GapNoMobileAppForOperatorsPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mobile-app-for-operators/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No mobile app for operators</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No mobile app for operators</p>
