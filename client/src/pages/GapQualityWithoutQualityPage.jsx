...
// Gap (AI): Quality without '/quality
// Quality without /quality-anomaly-detect (flag out-of-spec results)
import React, { useState } from 'react';

export default function GapQualityWithoutQualityPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-quality-without-quality/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Quality without '/quality</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Quality without /quality-anomaly-detect (flag out-of-spec results)</p>
