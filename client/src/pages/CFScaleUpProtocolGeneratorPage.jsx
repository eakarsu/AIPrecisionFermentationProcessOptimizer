...
// Custom Feature: Scale-up protocol generator
// Scale-up protocol generator: Lab-scale parameters input; AI generates scale-up recipe for production bioreactors; accounts for heat transfer, mixing differences; predicts production yields
import React, { useState } from 'react';

export default function CFScaleUpProtocolGeneratorPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-scale-up-protocol-generator/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Scale-up protocol generator</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Scale-up protocol generator: Lab-scale parameters input; AI generates scale-up recipe for production bioreactors; accounts for heat transfer, mixing differences; predicts production yields</p>
