...
// Custom Feature: Cross-batch learning
// Cross-batch learning: Aggregate data from hundreds of batches; identify key parameters driving yield/quality; auto-generate optimized recipes for new strains/targets
import React, { useState } from 'react';

export default function CFCrossBatchLearningPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-cross-batch-learning/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Cross-batch learning</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Cross-batch learning: Aggregate data from hundreds of batches; identify key parameters driving yield/quality; auto-generate optimized recipes for new strains/targets</p>
